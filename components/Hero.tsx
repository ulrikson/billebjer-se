  ...
  return (
    <section className="text-center py-16">
      ...
      <a
        ...
        className="mt-8 inline-block bg-white text-black border border-black rounded-full px-6 py-2 hover:bg-gray-100 transition-colors"
      >
        <span className="inline-block align-middle mr-2">
          {/* Basic Github Octocat SVG - replace with a proper icon if available */}
          <svg
            height="16"
            aria-hidden="true"
            viewBox="0 0 16 16"
